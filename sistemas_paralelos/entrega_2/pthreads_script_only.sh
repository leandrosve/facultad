...
BLOCK_SIZES=(64)
THREADS=(2 4 8)
REPORTE_TABLA="resultados/matrices_bloque_only_pthreads.txt"

# Preparación de directorios
mkdir -p compilados resultados

# Compilación
echo "🔨 Compilando matrices_bloque_only_pthreads.c..."
gcc -o compilados/matrices_bloque_only_pthreads matrices_bloque_only_pthreads.c -lm -O3 -pthread || exit 1
...
for N in "${MATRIX_SIZES[@]}"; do
    for BLOCK in "${BLOCK_SIZES[@]}"; do
        ...
        for T in "${THREADS[@]}"; do
            ...
            OUTPUT=$(./compilados/matrices_bloque_only_pthreads "$N" "$BLOCK" "$T")
