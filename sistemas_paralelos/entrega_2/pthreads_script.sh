...
BLOCK_SIZES=(64)
THREADS=(2 4 8)
REPORTE_TABLA="resultados/matrices_bloque_pthreads.txt"
...
gcc -o compilados/matrices_bloque_pthreads matrices_bloque_pthreads.c -lm -O3 -pthread || exit 1
...
for N in "${MATRIX_SIZES[@]}"; do
    for BLOCK in "${BLOCK_SIZES[@]}"; do
        ...
        for T in "${THREADS[@]}"; do
            ...
            OUTPUT=$(./compilados/matrices_bloque_pthreads "$N" "$BLOCK" "$T")
